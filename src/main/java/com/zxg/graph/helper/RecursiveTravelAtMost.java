 ...
 * 递归发现两点之间可能的路径
 */
public class RecursiveTravelAtMost {
    ...
    public RecursiveTravelAtMost(HashMap<String, HashSet<DirectedWeighedEdge>> input, String start, String end, int maxStop) {
        this.adj = input;
    ...
    public void traverse(String newStart) {
        ...
        if (tempStask.size() != 1 && newStart.equals(end)
                && tempStask.size() <= maxStop + 1) {
